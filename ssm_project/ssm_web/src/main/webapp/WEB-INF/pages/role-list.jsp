			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/path/pathname/role-add'">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/AddPermission?rid=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
												<a href="${pageContext.request.contextPath}/role/deletePermission?rid=${role.id}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
									总共${pageInfo.pages} 页，共${pageInfo.endRow}条数据。 每页 <select class="form-control">
									<option value="${pageInfo.pageSize}" selected>${pageInfo.pageSize}</option>
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
