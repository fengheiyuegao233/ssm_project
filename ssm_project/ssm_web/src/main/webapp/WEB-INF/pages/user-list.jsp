...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/path/pathname/user-add'">
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								总共${pageInfo.pages} 页，共${pageInfo.endRow}条数据。 每页 <select class="form-control" id="sel">
		...
		<script>
            ...
            $(function () {
                $("#sel").change(function () {
                    location.href="${pageContext.request.contextPath}/user/findAll?page=${pages.page}&pageSize="+$("#sel").val();
                })
            })
		</script>
</body>
